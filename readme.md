...
You can display the information box while displaying PDF file\. The box always displays the number of the displayed page and can display information about current adjust state\.
